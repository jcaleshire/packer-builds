...
variable "vm_guest_os_name_prefix" {
  type        = string
  description = "Prefix for the VM name. Used for naming only. Defaults to \"VM\"."
  default     = "VM"
}
...
variable "vm_mem_reserve_all" {
  type        = bool
  description = "Reserve all available host memory."
  default     = false
}
...
variable "communicator" {
  type        = string
  description = "Define the communication protocol to be used. Options are \"none\", \"ssh\", or \"winrm\"."
  default     = "ssh"
}
